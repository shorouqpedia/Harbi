...
echo $name;
            $sql = "UPDATE clients SET `name`='$name' , `phone_no`='0$phone' , `KM_counter`='$KM_counter' WHERE `id`=$id ";
...
?>">
            ...
            <div class="form-group">
                ...
                <input required data-check="[^0-9\\+]" type="text" id="phone" placeholder="01xxxxxxxxx" value="<?php echo $client['phone_no'];
?>" name="phone" class="form-control">
             ...
             <div class="form-group">
                ...
                <input disabled="true" required name="license_no" type="text" class="form-control" placeholder="<?php echo $client['license_no'];
?>">
            </div>
            
             <div class="form-group">
                <label for="brand" class="control-label">Brand</label>
                <input required name="brand" type="text" class="form-control" placeholder="<?php echo $client['brand'];?>" disabled='true'>
            </div>
            
            <div class="form-group">
                <label for="year" class="control-label">year</label>
                <input required name="year" type="number" class="form-control" placeholder="<?php echo $client['year'];?>" disabled='true' value="2018">
            </div>
             
             <div class="form-group">
                <label for="chassis_no" class="control-label">chassis Number</label>
                <input required name="chassis_no" type="text" class="form-control" placeholder="<?php echo $client['chassis_no'];?>" disabled='true'>
            </div>
            

            <div class="form-group">
                <label for="license_name" class="control-label">License Name</label>
                <input required name="license_name" type="text" class="form-control" placeholder="<?php echo $client['chassis_no'];?>" disabled="true">
            </div>

            <div class="form-group">
                <label for="KM_counter" class="control-label">KM_counter</label>
                <input required name="KM_counter" type="number" class="form-control" placeholder="eg:1200" value="<?php echo $client['KM_counter'];?>">
            </div>
